...
class MsgPartTest(MockMsgTest):
    ...
    def test_space_prefixed_to_content(self):
        ...
        msg = hacksaw.proc.remotesyslog.MsgPart(content="hello")
...
DEFAULT_PRI = hacksaw.proc.remotesyslog.PriPart(syslog.LOG_LOCAL4,
                                                syslog.LOG_NOTICE)
DEFAULT_HEADER = hacksaw.proc.remotesyslog.HeaderPart(DEFAULT_TIMESTAMP,
                                                      DEFAULT_HOSTNAME)
DEFAULT_MSG = hacksaw.proc.remotesyslog.MsgPart(DEFAULT_TAG, "hello")
...
class SyslogMessageTest(unittest.TestCase):
    ...
    def test_message_format(self):
        ...
        message = hacksaw.proc.remotesyslog.SyslogMessage(DEFAULT_PRI,
                                                          DEFAULT_HEADER,
                                                          DEFAULT_MSG)
    ...
    def test_max_lenth(self):
        ...
        message = hacksaw.proc.remotesyslog.SyslogMessage(DEFAULT_PRI,
                                                          DEFAULT_HEADER,
                                                          message)
        self.assertEqual(len(str(message)),
                         hacksaw.proc.remotesyslog.SyslogMessage.MAX_LEN)
...
class LoggerTest(MockHeaderTest, MockMsgTest):
    ...
    def test_send_message(self):
        ...
        message = hacksaw.proc.remotesyslog.SyslogMessage(DEFAULT_PRI,
                                                          ...
                                                          DEFAULT_MSG)
        mock_sock = Mock()
        port = hacksaw.proc.remotesyslog.Logger.PORT
        ...
        try:
            logger = hacksaw.proc.remotesyslog.Logger()
